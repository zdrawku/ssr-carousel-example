...
import { GridBatchEditingWithTransactionsComponent } from './grid-transaction.component';
import {
    IgxButtonModule,
    IgxDialogModule,
    IgxFocusModule,
...
describe('GridBatchEditingComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ GridBatchEditingComponent, GridBatchEditingWithTransactionsComponent ],
